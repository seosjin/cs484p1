...
def setHeader(x, f = ""):
    #I used https://stackoverflow.com/questions/237079/how-to-get-file-creation-modification-date-times-in-python to find the last modified time. West Point, Ny. 27 September 2017.
    timeMod = "Last-Modified: " + str(format_date_time(mktime(time.localtime(os.path.getmtime(f))))) + "\n"
    #I used https://stackoverflow.com/questions/225086/rfc-1123-date-representation-in-python for the proper HTTP date-time format. West Point, NY. 27 September 2017.
...
while True:
    ...
    #https://stackoverflow.com/questions/954504/how-to-get-files-in-a-directory-including-all-subdirectories used to look for files in the subdirectories. West Point, NY. 28 September 2017.
